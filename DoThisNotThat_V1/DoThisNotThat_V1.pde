...
void setup () {
  ...
  //
  xEllipseDisplay = xButton2;
  yEllipseDisplay = yRectDisplay;
...
void mousePressed () {
  rectON=false;
  ellipseON=false;
  if ( mouseX>=xButton1 && mouseX<=xButton1+button1Width && mouseY>=yButton1 && mouseY<=yButton1+button1Height ) rectON=true;
